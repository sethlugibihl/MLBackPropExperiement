...
# Max Epochs - SET AND LEAVE

# EXPERIEMENTAL FACTORS
# Learning Rate: 0.01, 0.001 etc...
# Num of nodes in hidden layer
# Root means square early exit if low
# or peftect accomplishment of test patterns
# graphing the plot/errors?

# they want to know the true error rate estimation

# Is the test data stratified
# Normalize the data?
